// 양방향 암호화: 암호화 한것을 다시 복호화 할 수 있음, 이때 반드시 key가 필요
...
/*
 ...
 - base64: 이진데이터를 네트워크 상에서 안전하게 전송하기 위해 텍스트로 바꿈(텍스트 이지만 아무의미 X)
 - 이진데이터를 포함한 암호화 결과, 이미지, 파일 등을 텍스트로 바꿀 때 사용
 예) <Buffer ec 93 20 ed 34 33..> -> iiopeG2GsYlk6ccoBoFvEH2EBDMWv1kK9bNuDjYxiN0=
*/

// 암호화
const cipher = crypto.createCipheriv(algorithm, key, iv)
let result = cipher.update('암호화할 문장', 'utf-8', 'base64') //암호화 + 인코딩
